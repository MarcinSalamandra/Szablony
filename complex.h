...
class Complex {
    ...
    public:
        ...
        Complex operator += (const Complex & Cn2);
        Complex operator *= (const Complex & Cn2);
        Complex operator *= (const double & multipler);
...
// przeciazenia operatorow strumieni wejscia / wyjscia dla liczby zespolonej i przeciazenie funkcji abs dla liczby zespolonej
