...
Complex Complex::operator += (const Complex & Cn2) {
    // dodajemy do siebie czesci: rzeczywista i urojona
    *this = *this + Cn2;
...
/***************************************************
* Przeciazenie operatora mnozenia z przypisaniem   *
***************************************************/
...
Complex Complex::operator *= (const double & multipler) {
    *this = *this * multipler;
...
/************************************************
* Przeciazenie operatora minusa przed liczba    *
************************************************/
...
bool Complex::operator == (const Complex & Cn2) const {
    ...
    if(abs(this->re - Cn2.re) < eps && abs(this->im - Cn2.im) < eps) {
        return true;
    }
    else {
        return false;
...
/********************************************
* Przeciazenie funkcji abs dla typu Complex *
********************************************/

double abs(const Complex & Cn) {
    double result;
